...
const removeJSX = (html: string, videoID: string) => {
  return html
    ...
    .replace(/<p>&lt;(AffiliateDisclaimer).*\/&gt;<\/p>/gm, '<p>Some links are affiliate links and I will receive some kind of commission if you purchase the service or product.</p>');
};
